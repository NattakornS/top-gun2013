...
/* Private variables ---------------------------------------------------------*/
/*Global*/
unsigned short Time_Rec_Base = 0;
...
extern int  Status_SendData ; 


extern __IO uint8_t ubRxIndex;
extern __IO uint8_t ubTxIndex;
extern __IO uint8_t ZB_TxIndex ; 

__IO uint8_t ubCounter = 0x00;
extern __IO uint32_t TimeOut;


extern unsigned char powermeter_meterToRs485( unsigned char *meterId, int id_len );
