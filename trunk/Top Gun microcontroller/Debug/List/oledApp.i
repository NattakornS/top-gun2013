...
void Oled_SSD1305_Init(){
	...
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00))->BSRRL = ((uint16_t)0x0040) ;
	delay(10);
	 
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00))->BSRRH = ((uint16_t)0x0040) ;
	delay(10);
	...
	write_I2C_command2(0xA8,0x3f);							
	
	write_I2C_command2(0xAD,0x8A);							
	
	
	write_I2C_command(0xAF);  								
	
	write_I2C_command2(0xD3,0x00);							
	
	
	write_I2C_command2(0xD5,0x61);							
	
	
	write_I2C_command2(0xD8,0x00);							
	
	
	write_I2C_command2(0xDA,0x12);							
	
	write_I2C_command2(0xDB,0x00);							
	
	write_I2C_command2(0xD9,0x22);							
	
	write_I2C_command2(0x8D,0x14);                                   
	write_I2C_command2(0x20,0x00);			                                 
...
void init_I2C1(void){
	...
	I2C_InitStruct.I2C_Ack = ((uint16_t)0x0400);		
	I2C_InitStruct.I2C_AcknowledgedAddress = ((uint16_t)0x4000); 
	I2C_Init(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), &I2C_InitStruct);				
...
void I2C_start(I2C_TypeDef* I2Cx, uint8_t address, uint8_t direction){
	...
	while(I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00020000)));
...
void write_I2C_command2(uint8_t command,uint8_t parameter)	
{
	
	I2C_start(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0x78 ,((uint8_t)0x00)); 
	
	I2C_write(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),0x80); 
	I2C_write(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),command);
	I2C_write(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),0x80);  
	I2C_write(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),parameter);    
	
	
	I2C_stop(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))); 
...
void write_I2C_command(uint8_t command)	
{
...
void write_I2C_data(uint8_t data)			
{
	...
	I2C_write(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),0x40);  
	I2C_write(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)),data);
...
void display_one_letter (unsigned char z, unsigned char column, unsigned char line)
{
	...
	a = 6*(column&0x0f)+18;				
	write_I2C_command(a&0x0f);			
	write_I2C_command((((a&0xf0)>>4)+0x10));  	
	a = (line&0x07);
	write_I2C_command(0xb0 + a);	                
