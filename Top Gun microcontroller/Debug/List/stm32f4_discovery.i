...
GPIO_TypeDef* BUTTON_PORT[1] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)) }; 

const uint16_t BUTTON_PIN[1] = {((uint16_t)0x0001) }; 

const uint32_t BUTTON_CLK[1] = {((uint32_t)0x00000001) };

const uint16_t BUTTON_EXTI_LINE[1] = {((uint32_t)0x00001) };

const uint8_t BUTTON_PORT_SOURCE[1] = {((uint8_t)0x00)};
								 
const uint8_t BUTTON_PIN_SOURCE[1] = {((uint8_t)0x00) }; 
const uint8_t BUTTON_IRQn[1] = {EXTI0_IRQn };
